...
Source0  : https://download.kde.org/stable/release-service/19.12.0/src/kmbox-19.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.0/src/kmbox-19.12.0.tar.xz.sig
...
%prep
%setup -q -n kmbox-19.12.0
cd %{_builddir}/kmbox-19.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576563844
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kmbox-19.12.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/kmbox/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5Mbox.so.5.13.0
