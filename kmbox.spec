...
Version  : 22.12.2
Release  : 50
URL      : https://download.kde.org/stable/release-service/22.12.2/src/kmbox-22.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.2/src/kmbox-22.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.2/src/kmbox-22.12.2.tar.xz.sig
...
%prep
%setup -q -n kmbox-22.12.2
cd %{_builddir}/kmbox-22.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676849777
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Mbox.so.5.22.2
