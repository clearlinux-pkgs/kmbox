...
Version  : 22.12.0
Release  : 47
URL      : https://download.kde.org/stable/release-service/22.12.0/src/kmbox-22.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.0/src/kmbox-22.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.0/src/kmbox-22.12.0.tar.xz.sig
...
%prep
%setup -q -n kmbox-22.12.0
cd %{_builddir}/kmbox-22.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670540703
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Mbox.so.5.22.0
