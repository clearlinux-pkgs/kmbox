...
Source0  : https://download.kde.org/stable/release-service/23.08.3/src/kmbox-23.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.3/src/kmbox-23.08.3.tar.xz.sig
...
%prep
%setup -q -n kmbox-23.08.3
cd %{_builddir}/kmbox-23.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699580662
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim5Mbox.so.5.24.3
/usr/lib64/libKPim5Mbox.so.5
/usr/lib64/libKPim5Mbox.so.5.24.3
