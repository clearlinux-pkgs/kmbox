...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/kmbox-22.08.0.tar.xz
...
%prep
%setup -q -n kmbox-22.08.0
cd %{_builddir}/kmbox-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661552841
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Mbox.so.5.21.0
