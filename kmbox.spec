...
Version  : 22.08.3
Release  : 46
URL      : https://download.kde.org/stable/release-service/22.08.3/src/kmbox-22.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.3/src/kmbox-22.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.3/src/kmbox-22.08.3.tar.xz.sig
...
%prep
%setup -q -n kmbox-22.08.3
cd %{_builddir}/kmbox-22.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667885064
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Mbox.so.5.21.3
